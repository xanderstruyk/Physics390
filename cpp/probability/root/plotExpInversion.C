...
plotExpInversion() { 
  ...
  TH1F * h_pdf = new TH1F("h_pdf","h_pdf",50,0,10.);
  TH1F * h_cdf = new TH1F("h_cdf","h_cdf",50,0,1.);
  TH1F * h_inv = new TH1F("h_inv","h_inv",50,0,10.);

  TTree * t = new TTree("t","t"); 
  t->ReadFile("data/exponential_inversion.dat", "index/i:pdf/D:cdf/D:inv/D");
  ...
  c->DrawFrame(0.,0.,10.,1.1*h_pdf->GetMaximum());
  h_pdf->Draw("sames");
  h_inv->Draw("samesp");
