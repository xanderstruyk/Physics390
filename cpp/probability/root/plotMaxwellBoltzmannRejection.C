void
plotMaxwellBoltzmannRejection() {

  //read in the data
  TTree * t1 = new TTree("t","t");
  t1->ReadFile("data/maxwell_boltzmann_rejection_1.dat","l0/C:index/I:l1/C:val/D");

  TTree * t2 = new TTree("t","t");
  t2->ReadFile("data/maxwell_boltzmann_rejection_2.dat","l0/C:index/I:l1/C:val/D");

  TTree * t5 = new TTree("t","t");
  t5->ReadFile("data/maxwell_boltzmann_rejection_5.dat","l0/C:index/I:l1/C:val/D");
